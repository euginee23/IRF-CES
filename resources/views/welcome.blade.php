...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-white dark:bg-zinc-900">
        ...
        <!-- Hero Section -->
        <section class="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-white dark:from-zinc-900 dark:to-zinc-800">
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <a href="#features" class="px-8 py-4 text-center text-blue-600 dark:text-blue-400 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 border border-blue-200 dark:border-blue-800 rounded-lg font-semibold text-lg transition-colors">
                                Learn More
                            </a>
                        </div>
                    </div>
                    <div class="relative">
                        <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-2xl p-6 border border-zinc-200 dark:border-zinc-700">
                            ...
                            <!-- Dashboard Preview -->
                            <div class="bg-zinc-50 dark:bg-zinc-900 rounded-lg p-4 space-y-4">
                                <!-- Header Stats -->
        ...
        <section id="features" class="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-zinc-900">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="p-6 bg-zinc-50 dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
