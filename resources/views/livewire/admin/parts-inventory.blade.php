...
<div class="space-y-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-2xl shadow-lg">
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-4xl font-bold text-white">Parts Inventory</h1>
                    </div>
                    <p class="text-blue-100 text-base ml-16">Manage spare parts stock and reorder points</p>
                </div>
                <button 
                    type="button"
                    wire:click="openCreateModal"
                    class="group relative px-6 py-3.5 text-base font-semibold text-blue-600 bg-white rounded-xl hover:bg-blue-50 transition-all duration-200 shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95">
                            ...
                            <tr class="group hover:bg-blue-50/50 dark:hover:bg-blue-950/20 transition-all duration-150">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <button 
                                            type="button"
                                            wire:click="adjustStock({{ $part->id }}, 'subtract')"
                                            @if($part->in_stock == 0) disabled @endif
                                            class="group p-2.5 text-red-600 hover:text-white hover:bg-red-600 dark:text-red-400 dark:hover:bg-red-600 rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-red-600"
                                        ...
                                        <button 
                                            type="button"
                                            wire:click="adjustStock({{ $part->id }}, 'add')"
                                            class="group p-2.5 text-emerald-600 hover:text-white hover:bg-emerald-600 dark:text-emerald-400 dark:hover:bg-emerald-600 rounded-lg transition-all"
                                        ...
                                        <button 
                                            ...
                                            class="group p-2.5 text-blue-600 hover:text-white hover:bg-blue-600 dark:text-blue-400 dark:hover:bg-blue-600 rounded-lg transition-all"
                                            title="Edit Part">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button 
                                            ...
                                            class="group p-2.5 text-red-600 hover:text-white hover:bg-red-600 dark:text-red-400 dark:hover:bg-red-600 rounded-lg transition-all"
                                            title="Delete Part">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @if($showModal)
        <div 
            ...
            <div class="fixed inset-0 bg-zinc-900/80 backdrop-blur-md transition-opacity" @click="$wire.closeModal()"></div>
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div 
                    ...
                    class="relative bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl max-w-4xl w-full border border-zinc-200 dark:border-zinc-800">
                    ...
                    <form wire:submit="save" class="p-8">
                        ...
                        <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t-2 border-zinc-200 dark:border-zinc-800">
                            <button 
                                type="button" 
                                wire:click="closeModal" 
                                class="px-6 py-3 text-sm font-semibold text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border-2 border-zinc-300 dark:border-zinc-700 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 transition-all">
                                Cancel
                            </button>
                            <button 
                                type="submit" 
                                class="px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
