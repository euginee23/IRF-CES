        ...
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
            ...
            <div class="mt-6 pt-6 border-t border-zinc-200 dark:border-zinc-700">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <a href="{{ route('job-orders.create') }}" wire:navigate class="flex items-center gap-2 px-4 py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-lg text-sm font-medium hover:bg-zinc-800 dark:hover:bg-zinc-100 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg>
                        New Job Order
                    </a>
                    <a href="{{ route('job-orders.index') }}" wire:navigate class="flex items-center gap-2 px-4 py-3 border border-zinc-300 dark:border-zinc-600 text-zinc-900 dark:text-white rounded-lg text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-zinc-50 dark:bg-zinc-900">
                        <tr>
                            ...
                            <th class="text-right px-6 py-3 text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wide">Actions</th>
                        </tr>
                    </thead>
                        ...
                        @foreach($recentOrders as $order)
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('job-orders.edit', $order) }}" wire:navigate class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                                        {{ $order->assignedTo ? 'Reassign' : 'Assign Technician' }}
                                    </a>
                                </td>
                            </tr>
                        @endforeach
