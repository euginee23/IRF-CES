<x-layouts.auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('password.confirm.store') }}" class="flex flex-col gap-6">
            ...
            <button type="submit" data-test="confirm-password-button" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                {{ __('Confirm') }}
            </button>
        </form>
    </div>
